...
function PromoCodesSettingsPage() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem('promoCodesSettings');
    if (stored) {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h1 className="font-bold text-2xl mb-6">Настройки промокодов</h1>
...
export default PromoCodesSettingsPage;
