...
import { SortDirection } from '../workers.filters';

function WorkersSettingsPage() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem('workersSettings');
    if (stored) {
...
export default WorkersSettingsPage;
